...
sudo apt-get install -y python3-dev build-essential python3-requests python3-setuptools python3-serial python3-requests bluetooth libffi-dev libssl-dev libbluetooth-dev rfkill

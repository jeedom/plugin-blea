...
Lorsque vous cliquez sur un de vos modules, vous arrivez sur la page de configuration de celui-ci. Comme partout dans Jeedom
...
Les NIU s'incluent très facilement, mettez Jeedom en Inclusion puis appuyez sur le bouton (aussi simple que cela).

...
while ($i < 257) {
	...
	while ($j < 17) {
		...
		echo '<label class="fa fa-square pixel' . $notfirstline .'" data-pixel="' . $i . '" style="color : #000000;font-size:2.5em; margin-top:-8px;margin-left:-3px; cursor: pointer;border-radius:0"></label>  ';
		$j++;
		$i++;
...
?>
	...
	<div class="col-lg-4">
		<div class="form-group">
			<a class="btn btn-warning" id="bt_sendAll"><i class="fas fa-paint-brush"></i> {{Afficher sur le Divoom}}</a>
		...
		<div class="form-group">
			...
			<a class="btn btn-success uploadimagedivoompixoo" id="bt_upload" style="display:none"><i class="fa fa-check"></i></a>
			<a class="btn btn-danger closeimagedivoompixoo" id="bt_close" style="display:none"><i class="fa fa-times"></i></a>
		</div>
	</div>
</div>
<script>
